      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">
            DateTuner helps you manage you time effectively. Create events, set
            your avalability, and let other book time with you seamlessly.
          </p>
          <Link href="/dashboard">
      ...
      <div className="mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="flex flex-col justify-center gap-4">
